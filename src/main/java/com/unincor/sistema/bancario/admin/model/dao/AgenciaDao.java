...
public class AgenciaDao {
    ...
    public Agencia buscarAgenciaPorCodigo(String codigoAgencia) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Teste buscar agencias do id");
        Agencia ag = agenciaDao.buscarAgenciaPorId(1l);
        System.out.println("Codigo: " + ag.getCodigoAgencia());
        
        
        System.out.println("Teste buscar agencia por código");
        String codigoAgencia = "1645"; 
        Agencia agPorCodigo = agenciaDao.buscarAgenciaPorCodigo(codigoAgencia);
        System.out.println("Código: " + agPorCodigo.getCodigoAgencia());
}
